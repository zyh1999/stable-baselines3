...
class PopArt(torch.nn.Module):
    """
    PopArt layer (copied from detach baseline).
    This layer maintains running mean/var of targets and rescales its weights/biases
    to preserve unnormalized outputs when the stats change.
    """

    def __init__(self, input_shape, output_shape, norm_axes=1, beta=0.99999, epsilon=1e-6):
        super().__init__()
    ...
    def debiased_mean_var(self):
        ...
        debiased_var = (debiased_mean_sq - debiased_mean**2).clamp(min=self.epsilon)
